...
class TablaHistorial(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        fetch_historial = parent.conn.getHistory() # Esto lo van a cambiar por el que corresponde a la pantalla
