...
CREATE TABLE HISTORIAL(
	...
	CONSTRAINT HISTORIAL_CLIENT_FK FOREIGN KEY (IdCliente) REFERENCES CLIENTE(IdCliente)
);
...
CREATE TABLE FACTURA(
	...
	CONSTRAINT FACTURA_CLIENT_FK FOREIGN KEY (IdCliente) REFERENCES CLIENTE(IdCliente),
	CONSTRAINT FACTURA_HISTORIAL_FK FOREIGN KEY (IdHistorial) REFERENCES HISTORIAL(IdHistorial)
);
...
CREATE TABLE ABONOS(
	...
	CONSTRAINT ABONO_CREDITO_FK FOREIGN KEY (IdCredito) REFERENCES CREDITO(IdCredito)
);